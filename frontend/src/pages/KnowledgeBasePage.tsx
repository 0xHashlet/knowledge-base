...
import { FileUp, Library, LogOut, Plus, RefreshCw, UploadCloud } from "lucide-react";
              ...
              <div className="detail-layout">
                ...
                <form className="upload-form" onSubmit={handleUpload}>
                  <label className="file-drop">
                    <UploadCloud size={26} />
                    <span>{file ? file.name : "选择 .txt 或 .pdf 文件"}</span>
                    <input accept=".txt,.pdf,text/plain,application/pdf" onChange={handleFileChange} type="file" />
                  </label>
